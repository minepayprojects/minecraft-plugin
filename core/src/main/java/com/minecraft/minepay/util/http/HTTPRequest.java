package com.minecraft.minepay.util.http;
...
//        return AccessController.doPrivileged(action);
    ...
    public void sendBody(String body) throws HttpRequestException {
        try {
            openOutput();

            try (DataOutputStream dataOutputStream = new DataOutputStream(getConnection().getOutputStream())) {
